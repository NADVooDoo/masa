...
var _initHeroSwiper = require("./modules/init-hero-swiper");
// ---------------------------------
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  menu.init();
  (0, _initHeroSwiper.getHeroSlider)();
...
},{"./modules/form-validate/form":3,"./modules/init-hero-swiper":9,"./modules/menu":10,"./modules/modals/init-modals":11,"./utils/ios-vh-fix":15}],2:[function(require,module,exports){
"use strict";
...
var getHeroSlider = function getHeroSlider() {
...
exports.getHeroSlider = getHeroSlider;

},{"../utils/is-mobile-device":16,"../vendor/swiper":18}],10:[function(require,module,exports){
"use strict";
...
function menuDropdown(event) {
  ...
  var listItem = button.closest('.nav__item');
  menu.classList.toggle('is-open');
  listItem.classList.toggle('is-open');
}
var dropdownButtons = document.querySelectorAll('[data-dropdown-button]');
